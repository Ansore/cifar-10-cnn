...
def cnn_train(batch, x_train, y_train, x_test, y_test):
    ...
    with tf.Session() as sess:
        ...
        last_epoch = load_model(sess, saver, 'save_model_tmp_vgg16_mod/')
        ...
        for n in range(last_epoch + 1, 1000):
                ...
                if (n*num_batch+i) % 50 == 0:
                    ...
                    if acc > 0.77:
                        constant_graph = graph_util.convert_variables_to_constants(sess, sess.graph_def,
                                                                                   ["outnode"])
                        with tf.gfile.FastGFile("android_vgg16_mod/vgg16_mod_model-"+str(acc)+".pb", mode='wb') as f:
            ...
            saver.save(sess, 'save_model_tmp_vgg16_mod/cifar.model', global_step=n)
        print('准确度小于0.81!')
